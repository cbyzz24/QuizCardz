...
def display_question():
    ...
    st.session_state["civics_question_text"] = questions[random_question][0]
    st.session_state["civics_answer_text"] = ""  # Clear the answer when showing a new question

def display_answer():
    if "civics_question_text" in st.session_state:
        civics_question_text = st.session_state["civics_question_text"]
        for question, answer in questions:
            if question == civics_question_text:
                st.session_state["civics_answer_text"] = answer
                break

if "civics_question_text" not in st.session_state:
    st.session_state["civics_question_text"] = ""
if "civics_answer_text" not in st.session_state:
    st.session_state["civics_answer_text"] = ""
...
with st.container(height=180):
    ...
    # with header_title:
    st.write("###### Question:")
    civics_question_text = st.write(st.session_state["civics_question_text"])
...
with st.container(height=180):
    ...
    # with header_title:
    st.write("###### Answer:")
    civics_answer_text = st.write(st.session_state["civics_answer_text"])